...
for fNo in ['2a']: # ['1','2a','2b']:
  ...
  if fNo == '1':
    ...
    figCaption2 = r"arc-maximum concentrations. The AERMOD(Base) model is the EPA's current"
    figCaption3 = r'operational model and the AERMOD(Beta 4) is AERMOD beta option 4 with'
    figCaption4 = r'adjusted $u_*$ and $\sigma_v$= 0.3 m/sec'
    plt.text(-0.4,-0.17,figCapNo,fontsize=13,transform=ax.transAxes,fontproperties=font_bold)
    plt.text(-0.18,-0.17,figCaption1,fontsize=13,transform=ax.transAxes)
    ...
    #plt.text(-0.1,-0.17,figCapNo,fontsize=13,transform=ax.transAxes,fontproperties=font_bold)
    #plt.text(0.08,-0.17,figCaption1,fontsize=13,transform=ax.transAxes)
    #plt.text(-0.1,-0.22 ,figCaption2,fontsize=13,transform=ax.transAxes)
    #plt.text(-0.1,-0.27,figCaption3,fontsize=13,transform=ax.transAxes)    
    #plt.text(-0.1,-0.32,figCaption4,fontsize=13,transform=ax.transAxes)
    #
    ...
    figCaption1 = r'Scatter plot for OakRidge observed and predicted hourly-averaged'
    figCaption2 = r"arc-maximum concentrations. AERMOD(Beta 4) is AERMOD beta option 4 with"
    figCaption3 = r'adjusted $u_*$ and $\sigma_v$= 0.3 m/sec'
    plt.text(-0.4,-0.17,figCapNo,fontsize=13,transform=ax.transAxes,fontproperties=font_bold)
